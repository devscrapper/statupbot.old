module VisitorFactory
  class Chrome < Browser
    ...
    def initialize(browser_details, nationality, geolocation, visitor_id)
      ...
      cq.add_var_query("utmcs", nationality.charset(browser_details[:operating_system], browser_details[:browser]))
      ...
      cq.add_var_query("utme", "Chrome#{browser_details[:browser_version]} \
