...
module Pages
  ...
  class Website < Page
    ...
    #----------------------------------------------------------------------------------------------------------------
    #----------------------------------------------------------------------------------------------------------------
    # retourne une des occurences d'advert présent sur la page
    #----------------------------------------------------------------------------------------------------------------
    def advert(advertising)
      begin
        ad = advertising.advert { |link_identifier, domain| @browser.find_links(link_identifier, domain) }
        ...
        @@logger.an_event.debug "advert #{ad.to_s}"
        ad[0] #retourn l'objet sahi contenant l'advert
      end
    end
