...
ScriptOpener = function() {
	...
	this.refreshScenarioListFile = function(dir){
		return eval("(" + sahiSendToServer("/_s_/dyn/ControllerUI_scenariosListJSON?dir="+encodeURIComponent(dir)) + ")");
	}
	
	this.refreshSheetListFile = function(dir){
		return eval("(" + sahiSendToServer("/_s_/dyn/ControllerUI_sheetListJSON?dir="+encodeURIComponent(dir)) + ")");
	}
	...
	this.refreshScriptListFile = function(dir){
		return eval("(" + sahiSendToServer("/_s_/dyn/ControllerUI_scriptsListJSON?dir="+encodeURIComponent(dir)+"&suites=" + encodeURIComponent(_showSuites)) + ")");
	}
