...
Sahi.prototype.current_page_details = function (with_links) {
    ...
    try {
        if (with_links == true) {
            return JSON.stringify({url: window.location.href, title: window.document.title, referrer: window.document.referrer, links: links_in_window(window), cookies: window.document.cookie});
        }
        else {
            return JSON.stringify({url: window.location.href, title: window.document.title, referrer: window.document.referrer, links: [], cookies: window.document.cookie});
        }
