...
Sahi.prototype.links = function () {
    ...
    try {
        ...
        //return links_in_window(window).toJSONString() ;
    }
    catch (e) {
...
function is_selectable(link, url_window) {
    //trace.write("valid") ;
    var href = link.href;
    //trace.write("Link.prototype.valid href : " + href +" <br>");
    var uri = new Uri(href);
    //trace.write("Link.prototype.valid uri : " + uri +" <br>");
    var protocol = uri.protocol();
    //trace.write("Link.prototype.valid protocol : " + protocol +" <br>");
    var path = uri.path();
    //trace.write("Link.prototype.valid path : " + path +" <br>");
    var length = ".svg".length;


    //trace.write("Link.prototype.valid link.textContent : " + link.textContent +" <br>");
    //trace.write("Link.prototype.valid link.target : " + link.target +" <br>");
