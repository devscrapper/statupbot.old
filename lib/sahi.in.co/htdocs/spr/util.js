...
var isSahiPlaybackOnlyModeEnabled;
function isSahiPlaybackOnlyEnabled() {
		if(isSahiPlaybackOnlyModeEnabled === undefined)
		isSahiPlaybackOnlyModeEnabled = eval("(" + sahiSendToServer("/_s_/dyn/Configuration_isSahiPlaybackOnlyEnabled") + ")");
		return isSahiPlaybackOnlyModeEnabled;
}